        ...
        <div>
            ...
            <div className='flex w-[80%] justify-center items-center flex-col m-auto mt-5'>
                ...
                <div className="flex flex-row max-h-40">
                        <a href="#" class="ml-5 block max-w-sm p-6 border rounded-lg shadow-md bg-gray-800 border-gray-700 hover:bg-gray-700">      
                            <p class="font-normal text-gray-400">Total Number Of Clicks</p>
                        ...
                        {projectsList.map((project) => {
                            return (
                                <div key={project._id} className="mt-10">
                                    <a href="#" class="flex flex-col items-center border rounded-lg shadow-md md:flex-row w-full border-gray-700 bg-gray-800 hover:bg-gray-700">
