...
const Projects = () => {
    ...
    const getProjects = async () => {
        setLoading(true);
        const response = await fetch(`http://localhost:8181/api/auth/getprojects/6/${currentPage}`, {
            method: 'GET',
            headers: {
    ...
    useEffect(() => {
      console.log(filteredProjectLists);
          ...
          <div className="flex items-baseline justify-between border-b border-gray-200 pt-10 pb-6">
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left mr-8">
                ...
                {filteredProjectLists.length === 0 && !loading?
                    ...
                    <InfiniteScroll
                      ...
                      hasMore={projectList.length !== totalItem}
                      loader={<Loader />}
                      endMessage={
